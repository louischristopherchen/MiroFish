...
（使用本地 SQLite + ChromaDB，替代 Zep Cloud）
...
class ZepToolsService:
    ...
    def __init__(self, api_key: Optional[str] = None, llm_client: Optional[LLMClient] = None):
        # api_key kept for backward-compatible call sites
    ...
    def _call_with_retry(self, func, operation_name: str, max_retries: int = None):
        """Simple call wrapper — retry logic largely unnecessary for local DB, kept for interface compat."""
        try:
            return func()
    ...
    def search_graph(
        ...
        try:
            ...
            logger.info(t("console.searchComplete", count=result.get("total_count", 0)))
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        try:
            edges = self.store.get_edges_by_node(node_uuid)
